...
class IBOutBuf : public cSimpleModule
{
 private:
  ...
  // statistics
  cHistogram   qDepthHist;      // number of flits in the out queue
  cHistogram packetStoreHist; // number of packets in the queue
  cHistogram flowControlDelay;// track the time between flow controls
